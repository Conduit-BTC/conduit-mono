...
test("pending event pickup retries unresolved terms and reapplies them after quantity correction @market", async ({
  page,
}) => {
  test.setTimeout(120_000)
  const relay = createRelayHarness()
  ...
  relay.remove(market.pickupEvent!)
