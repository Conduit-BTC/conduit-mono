        ...
        <div className="grid gap-3 border-t border-[var(--border)] pt-3">
          <div>
            ...
            <p className="mt-1 text-xs leading-5 text-[var(--text-muted)]">
              ...
              product will reference the exact event and one public pickup
              option. You choose who hands the item to the buyer.
            </p>
          </div>
            ...
            <div className="grid gap-2" aria-label="Event handoff handler">
              ...
              >
                ...
                <span className="mt-1 block text-xs leading-5 text-[var(--text-muted)]">
                  ...
                  remotely while the organizer uses your signed handoff
                  instruction and pickup code. They do not receive independent
                  payment proof, the full order, buyer contact, notes, address,
                  invoice, or payment secrets.
                </span>
              </Button>
