...
function StatCard({
  ...
  return (
    <div className="rounded-[1.4rem] border border-white/10 bg-white/[0.04] p-4 shadow-[var(--shadow-glass-inset)]">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1.3fr)_minmax(320px,0.9fr)]">
        <section className="rounded-[1.6rem] border border-white/10 bg-white/[0.04] p-5 shadow-[var(--shadow-glass-inset)]">
          <div className="flex items-start justify-between gap-3">
            <div>
              <div className="text-xs uppercase tracking-[0.18em] text-[var(--text-muted)]">
                Things to do next
