  ...
  return (
    <div className="mx-auto max-w-[54rem] py-2 sm:py-6">
      <div className="mx-auto max-w-[50rem]">
        <section className="rounded-[2.25rem] border border-[var(--border)] bg-[radial-gradient(circle_at_top,color-mix(in_srgb,var(--primary-500)_14%,transparent),transparent_40%),color-mix(in_srgb,var(--surface)_98%,var(--primary-500)_2%)] p-5 shadow-[var(--shadow-dialog)] sm:p-8">
          <div className="space-y-8">
            ...
            {!editing && profileQuery.data && (
              <section className="space-y-4">
                ...
                <div className="overflow-hidden rounded-[2rem] bg-[color-mix(in_srgb,var(--surface)_98%,var(--primary-500)_2%)] shadow-[var(--shadow-glass-inset)]">
                  {/* Banner */}
                  {profileData?.banner ? (
