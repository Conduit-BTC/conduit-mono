...
- Nostr-sensitive PRs cite `docs/knowledge/external-nostr-references.md` and the relevant public NIP or Open Markets specification source
- Product listings remain NIP-99 plus the Open Markets Specification for `kind:30402` commerce events; flag alternate product-listing protocol assumptions
