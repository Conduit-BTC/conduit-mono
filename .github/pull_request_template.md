...
- [ ] Product listings remain NIP-99 plus the Open Markets Specification for `kind:30402` commerce events; no alternate product-listing protocol terminology, schemas, or assumptions introduced
