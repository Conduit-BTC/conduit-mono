...
- Nostr-sensitive work must cite `docs/knowledge/external-nostr-references.md` and the relevant public NIP or Open Markets specification source
- Product listings are NIP-99 plus the Open Markets Specification for `kind:30402` commerce events, derived from the earlier GammaMarkets `market-spec` work; alternate product-listing protocol assumptions are out of scope
