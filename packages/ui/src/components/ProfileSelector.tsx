  ...
  return (
    <DropdownMenu open={open} onOpenChange={setOpen}>
      ...
      <DropdownMenuContent
        align="end"
        sideOffset={8}
        className="w-[15rem] rounded-[1.1rem] border border-primary-400/20 bg-[color-mix(in_srgb,var(--background)_18%,var(--primary-950)_82%)] p-0 shadow-[0_28px_60px_color-mix(in_srgb,black_56%,transparent)] backdrop-blur-xl"
      >
        <div className="p-3">
