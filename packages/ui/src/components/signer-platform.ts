...
/** Keep the NIP-46 request intact while targeting Amber on Android. */
export function androidSignerConnectUrl(nostrConnectUri: string): string {
  ...
  return `intent:${connection}#Intent;scheme=nostrconnect;package=${AMBER_PACKAGE_NAME};end`
}
