...
function fromCachedProduct(row: CachedProduct): CommerceProductRecord {
  ...
  const product: Product = {
    ...
    shippingOptionLaunchUnsupported: row.shippingOptionLaunchUnsupported,
    shippingCountries: row.shippingCountries,
    shippingCountryRules: row.shippingCountryRules,
    shippingZones: row.shippingZones,
    canonicalShippingResolved: row.canonicalShippingResolved,
    shippingOptionCreatedAt: row.shippingOptionCreatedAt,
