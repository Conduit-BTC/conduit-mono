...
These notes are a token-efficient preflight for Conduit agents working on Nostr client behavior. They are not full protocol mirrors and they do not replace canonical sources.
