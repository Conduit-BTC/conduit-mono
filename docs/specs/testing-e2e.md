...
protected preview or live-canary environment. Store their private keys as
environment secrets or in an approved external signer. Never expose them to a
workflow that executes untrusted pull request code.
