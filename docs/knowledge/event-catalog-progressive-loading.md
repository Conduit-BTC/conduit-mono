...
Regaining browser focus does not start another catalog read. Users can refresh
explicitly, while a stale remount still follows the normal query refresh path.
